...
```
This person class is created with the keyword **_class_** and within this class the instance variables are created. In this case those variables are name and age. In the main function, the object is instantiated by first stating the type which is the name of the class, "Person" and next to it, what ever you choose to name the object. In my example, I created twp instances of the Person class, the first being _Person perObj1_ and the second being _Person perObj2_. 
